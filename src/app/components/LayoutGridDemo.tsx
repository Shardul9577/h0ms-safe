...
const SkeletonTwo = () => {
  return (
    <div>
      <p className='font-bold text-4xl text-white'>The Figures</p>
      <p className='font-normal text-base my-4 max-w-lg text-neutral-200'>
        In India, fatal road accidents are commonly caused by over-speeding,
        which leads to severe crashes due to reduced reaction times. Drunk
...
const SkeletonFour = () => {
  return (
    <div>
      <p className='font-bold text-4xl text-white'>Sure Signs</p>
      <p className='font-normal text-base my-4 max-w-lg text-neutral-200'>
        In highly congested cities like Mumbai and Delhi, common signs of
...
const SkeletonSix = () => {
  return (
    <div>
      <p className='font-bold text-4xl text-white'>Multiple Reasons</p>
      <p className='font-normal text-base my-4 max-w-lg text-neutral-200'>
        Road accidents are commonly caused by a combination of human error,
